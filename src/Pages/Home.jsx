...
const WORDS = ["Network & E-commerce", "Technical Architecture", "Tech Enthusiast", ];
const TECH_STACK = ["React", "Node.js", "Kubernetes", "AWS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/cuong1379" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nguyen-cuong-825a98160/" },
  { icon: Instagram, link: "https://www.instagram.com/cuong_shawn" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Designing experiences so smooth, even your grandma would love them!.
                </p>
